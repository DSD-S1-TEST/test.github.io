import { B as select_default, H as __name, U as log, W as setLogLevel } from "./src-CfXVeLh3.js";
import { F as reset, G as setSiteConfig, H as setConfig, J as styles_default, M as registerDiagram, N as registerLazyLoadedDiagrams, S as getDiagramLoader, T as getSiteConfig, X as updateSiteConfig, Y as themes_default, Z as purify, c as configureSvgSize, f as detectType, g as frontMatterRegex, h as evaluate, l as defaultConfig, n as addDirective, p as detectors, r as assignWithDepth_default, t as UnknownDiagramError, w as getEffectiveHtmlLabels, x as getDiagram, y as getConfig, z as saveConfigFromInitialize } from "./chunk-7R4GIKGN-BwvQikhQ.js";
import { a as encodeEntities, d as isDetailedError, h as utils_default, i as decodeEntities, m as removeDirectives, r as cleanAndMerge } from "./chunk-GEFDOKGD-BD9gAK69.js";
import { t as selectSvgElement } from "./chunk-HHEYEP7N-BVhl1B0W.js";
import { n as load, t as JSON_SCHEMA } from "./chunk-XPW4576I-D-aJuJef.js";
import "./chunk-MX3YWQON-Bet-fFXL.js";
import "./chunk-YBOYWFTD-C0xtoQYT.js";
import "./chunk-PQ6SQG4A-IDDTGRu8.js";
import { i as registerIconPacks, o as dedent } from "./chunk-PU5JKC2W-cWJnAG1I.js";
import "./chunk-KYZI473N-CpZxIcB_.js";
import "./chunk-O4XLMI2P-dAtGnTry.js";
import { n as registerLayoutLoaders } from "./chunk-GLR3WWYH-BAejF3Iq.js";
...
var c4Detector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./c4Diagram-IC4MRINW-B0ArH_7z.js");
		return {
			id,
			diagram: diagram2
		};
...
var flowDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./flowDiagram-PKNHOUZH-I5NmgjSW.js");
		return {
			id: id2,
			diagram: diagram2
		};
...
var erDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./erDiagram-INFDFZHY-A00R-Hli.js");
		return {
			id: id4,
			diagram: diagram2
		};
...
var gitGraphDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./gitGraphDiagram-K3NZZRJ6-D34P0Huy.js");
		return {
			id: id5,
			diagram: diagram2
		};
...
var ganttDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ganttDiagram-A5KZAMGK-EPvI2IT3.js");
		return {
			id: id6,
			diagram: diagram2
		};
...
var info = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./infoDiagram-LFFYTUFH-BqguaZsY.js");
		return {
			id: id7,
			diagram: diagram2
		};
...
var pie = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./pieDiagram-SKSYHLDU-Dx92vXwN.js");
		return {
			id: id8,
			diagram: diagram2
		};
...
var quadrantDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./quadrantDiagram-337W2JSQ-G12UfTp3.js");
		return {
			id: id9,
			diagram: diagram2
		};
...
var xychartDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./xychartDiagram-JWTSCODW-B2Cm38Fk.js");
		return {
			id: id10,
			diagram: diagram2
		};
...
var requirementDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./requirementDiagram-Z7DCOOCP-C-ildfY6.js");
		return {
			id: id11,
			diagram: diagram2
		};
...
var sequenceDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./sequenceDiagram-2WXFIKYE-CcqNnjZb.js");
		return {
			id: id12,
			diagram: diagram2
		};
...
var classDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-VBA2DB6C-B_Ro0eRq.js");
		return {
			id: id13,
			diagram: diagram2
		};
...
var classDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-v2-RAHNMMFH-BSosWyJd.js");
		return {
			id: id14,
			diagram: diagram2
		};
...
var stateDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-RAJIS63D-DZ2nHkuh.js");
		return {
			id: id15,
			diagram: diagram2
		};
...
var stateDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-v2-FVOUBMTO-Dg43qzjN.js");
		return {
			id: id16,
			diagram: diagram2
		};
...
var journeyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./journeyDiagram-4ABVD52K-CaD2MUZd.js");
		return {
			id: id17,
			diagram: diagram2
		};
...
var detector_default2 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./timeline-definition-YZTLITO2-BMNN6Fbf.js");
		return {
			id: id19,
			diagram: diagram2
		};
...
var detector_default3 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./mindmap-definition-YRQLILUH-W_NEdIkL.js");
		return {
			id: id20,
			diagram: diagram2
		};
...
var detector_default4 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./kanban-definition-K7BYSVSG-BX7DooZG.js");
		return {
			id: id21,
			diagram: diagram2
		};
...
var sankeyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./sankeyDiagram-WA2Y5GQK-qTC33DFg.js");
		return {
			id: id22,
			diagram: diagram2
		};
...
var packet = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-P4PSJMXO-DjaAjNzT.js");
		return {
			id: id23,
			diagram: diagram2
		};
...
var radar = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-IFDJBPK2-DZqHsrV-.js");
		return {
			id: id24,
			diagram: diagram2
		};
...
var blockDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./blockDiagram-WCTKOSBZ-Dgrd-Wic.js");
		return {
			id: id25,
			diagram: diagram2
		};
...
var architectureDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./architectureDiagram-2XIMDMQ5-Dl_NCosM.js");
		return {
			id: id26,
			diagram: diagram2
		};
...
var ishikawa = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ishikawaDiagram-PHBUUO56-Chu2hj5n.js");
		return {
			id: id27,
			diagram: diagram2
		};
...
var vennDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./vennDiagram-LZ73GAT5-DUvuERC4.js");
		return {
			id: id28,
			diagram: diagram2
		};
...
var treemap = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-E7M64L7V-BEOi_CbE.js");
		return {
			id: id29,
			diagram: diagram2
		};
