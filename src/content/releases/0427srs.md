...
** [Click here to download the raw file.](./assets/releases/0427srs.md) **
...
| :--- | :--- | :--- | :--- | :--- |
| 1 | Requirements_Analysis_Sample_EN | M1 | SRS format specification | Pending update |
| 2 | S2 SRS | S2 | Team S2's SRS. Referred to their requirements regarding integration with our team. | Pending update |
| 3 | V2 SRS | V2 | Team V2's SRS. Referred to their description of the overall project. | Pending update |
| 4 | M1 SRS | M1 | Team M1's SRS. Referred to their requirements for External Use Cases. | Pending update |
